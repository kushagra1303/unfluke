      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] ">
          ...
          <p className={`${styles.paragraph} ml-2`}>
            <span className="text-white">Free 30 days</span> Subscription{" "}
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100.8px] leading-[75px]">
            One stop to <br className="sm:block hidden" />{" "}
            <span className="text-gradient">Strategize</span>{" "}
          </h1>
        ...
        <h1 className="font-poppins font-semibold ss:text-[68px] text-[52px] text-white ss:leading-[100.8px] leading-[75px] w-full">
          your <span className="text-gradient">Ideas</span>{" "}
        </h1>
